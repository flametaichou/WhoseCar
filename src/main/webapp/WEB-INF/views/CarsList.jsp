...
<body ng-app="myApp" class="ng-cloak">
    ...
    <div class="empty-height-min"></div>
    <main role="main" class="container text-white">
          <div class="generic-container" ng-controller="AppController as ctrl">
              <div ng-if="ctrl.cars" class="panel panel-default">
                 <div class="panel-heading"><span class="lead">Список всех машин:</span></div>
              ...
              <div ng-if="!ctrl.cars" class="alert alert-light" role="alert">Машин не найдено!</div>
          </div>
    </main>
