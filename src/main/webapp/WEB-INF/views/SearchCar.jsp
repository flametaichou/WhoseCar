...
<body ng-app="myApp" class="ng-cloak">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="<c:url value='/search-car/' />">По номеру <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <main role="main" class="container text-white">
          <h1 class="mt-5">Поиск авто по номеру</h1>
          <p class="lead">Введите номер авто и получите номер квартиры в которой проживает владелец</p>


          <div class="generic-container" ng-controller="AppController as ctrl">
              <div class="input-group mb-3 input-group-lg">
                <input type="text" ng-model="carnumber" class="form-control" placeholder="Введите номер авто" aria-label="Введите номер авто" aria-describedby="basic-addon2">
                <div class="input-group-append">
                  <button class="btn btn-primary" ng-click="ctrl.byCarNumber()" ng-onload="ctrl.byCarNumber()" type="submit">Искать</button>
                </div>
              </div>
              <div ng-if="ctrl.flag">
              ...
              <div ng-if="!ctrl.cars" class="alert alert-light" role="alert">Машин по вашему запросу не найдено!</div>
          </div>
    </main>
